---
title: "Subsequent Infections - Figure S4 & S5 HIGH RISK"
...
#           iptw_description = paste0("covid_flu_", outcome_15_300, "highrisk"))

rsv_iptw_15_300 <- results_tbl( paste0(paste0("covid_flu_", outcome_15_300, "highrisk"),'_tabc')) %>% collect()
...
#            exp = TRUE)
# p_s4a <- p_s4a + scale_y_discrete(labels = c("High risk conditions", 
...
#   labs(x = "Odd ratios", y = "") 
# 
# ggsave("figures/NEW_Figure_s4a_rsv_15_300_highrisk.png", plot = p_s4a, width = 20, height = 10, unit = "cm")
...
iptw_flu_30_180 <- analytic_dataset_final %>%
  mutate(exclude = case_when( is.na(days_from_index_to_rsv) ~ 0,
                              days_from_index_to_rsv >= 15 ~ 0,
                              TRUE ~ 1)) %>%
  filter(exclude==0) %>%
  do_iptw(cohort_entry_start_date = cohort_entry_start_date,
          comparison_cohort = comparison_group,
          weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
          iptw_description = paste0("covid_flu_", outcome_30_180, "highrisk"))

rsv_iptw_30_180 <- results_tbl( paste0(paste0("covid_flu_", outcome_30_180, "highrisk"),'_tabc')) %>%
  collect()
...
ggsave("figures/NEW_Figure_s4b_rsv_30_180_highrisk.png", plot = p_s4b, width = 20, height = 10, units = "cm")
...
iptw_flu_2b_no_covid <- analytic_dataset_final_resp %>%
  ...
  do_iptw(cohort_entry_start_date = cohort_entry_start_date,
          comparison_cohort = comparison_group,
          weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
          iptw_description = paste0("resp_study_covid_flu_", outcome_ari, "_highrisk"))

dataset_with_iptw_ari <- results_tbl( paste0(paste0("resp_study_covid_flu_", outcome_ari, "_highrisk"),'_tabc')) %>%
  collect()
...
p_s5a <- plot_summs(models_ari$model_unweighted_unadjusted,
           ...
           model.names = c("Unweighted, unadjusted",
                           ...
                           # "Weighted, adjusted for CE week"),
           exp = TRUE)
p_s5a <- p_s5a + scale_y_discrete(labels = c("High risk conditions",
                                "Hopspitalized for index infection", 
                                "Male", 
                                "Other/Unknown Race", "Non-Hispanic White", "Non-Hispanic Multiple", "Non-Hispanic Black/AA", "Non-Hispanic Asian/PI",
                                "6m-1y old", "4-5y old", "3-4y old", "2-3y old", "1-2y old", "SARS-CoV-2 Infection")) +
...
ggsave("figures/NEW_Figure_s5a_ari_exclude_covid_30_180_highrisk.png", plot = p_s5a, width = 20, height = 10, units = "cm")
```
...
iptw_flu_5b_no_covid <- analytic_dataset_final_resp %>%
  ...
  do_iptw(cohort_entry_start_date = cohort_entry_start_date,
          comparison_cohort = comparison_group,
          weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
          iptw_description = paste0("resp_covid_flu", outcome_ari_15, "_highrisk"))

dataset_with_iptw_ari_15 <- results_tbl( paste0( paste0("resp_covid_flu", outcome_ari_15, "_highrisk"),'_tabc')) %>%
  collect()
...
p_s5b <- plot_summs(models_ari_15$model_unweighted_unadjusted,
           ...
           model.names = c("Unweighted, unadjusted",
                           ...
                           # "Weighted, adjusted for CE week"),
           exp = TRUE)
p_s5b <- p_s5b + scale_y_discrete(labels = c("High risk conditions",
                                "Hopspitalized for index infection", 
                                "Male", 
                                "Other/Unknown Race", "Non-Hispanic White", "Non-Hispanic Multiple", "Non-Hispanic Black/AA", "Non-Hispanic Asian/PI",
                                "6m-1y old", "4-5y old", "3-4y old", "2-3y old", "1-2y old", "SARS-CoV-2 Infection")) +
...
ggsave("figures/NEW_Figure_s5b_ari_exclude_covid_15_180_highrisk.png", plot = p_s5b, width = 20, height = 10, units = "cm")
```
...
iptw_flu_2c_exclude_covid <- analytic_dataset_final_resp %>%
  ...
  do_iptw(cohort_entry_start_date = cohort_entry_start_date_resp,
          ...
          weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
          iptw_description = paste0("resp_stdy_covid_flu", outcome, "_highrisk"))

dataset_with_iptw <- results_tbl( paste0(paste0("resp_stdy_covid_flu", outcome, "_highrisk"),'_tabc')) %>%
  collect()
...
p_s5c <- p_s5c + scale_y_discrete(labels = c("High risk conditions",
                                "Hopspitalized for index infection", 
                                "Male", 
                                "Other/Unknown Race", "Non-Hispanic White", "Non-Hispanic Multiple", "Non-Hispanic Black/AA", "Non-Hispanic Asian/PI",
                                "6m-1y old", "4-5y old", "3-4y old", "2-3y old", "1-2y old", "SARS-CoV-2 Infection")) +
...
ggsave("figures/NEW_Figure_s5c_general_exclude_covid_30_180_highrisk.png", plot = p_s5c, width = 20, height = 10, units = "cm")
```
...
any_inf_iptw_flu_outcome_general_15_180 <- analytic_dataset_final_resp %>%
  ...
  do_iptw(cohort_entry_start_date = cohort_entry_start_date_resp,
          comparison_cohort = comparison_group,
          weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
          iptw_description = paste0("resp_study_covid_flu", outcome_general_15_180, "_highrisk"))

dataset_with_iptw_general_15_180 <- results_tbl( paste0(paste0("resp_study_covid_flu", outcome_general_15_180, "_highrisk"),'_tabc')) %>%
  collect()
...
p_s5d <- plot_summs(models_general_15_180$model_unweighted_unadjusted,
           ...
           model.names = c("Unweighted, unadjusted",
                           ...
                           # "Weighted, adjusted for CE week"),
           exp = TRUE)
p_s5d <- p_s5d + scale_y_discrete(labels = c("High risk conditions",
                                "Hopspitalized for index infection", 
                                "Male", 
                                "Other/Unknown Race", "Non-Hispanic White", "Non-Hispanic Multiple", "Non-Hispanic Black/AA", "Non-Hispanic Asian/PI",
                                "6m-1y old", "4-5y old", "3-4y old", "2-3y old", "1-2y old", "SARS-CoV-2 Infection")) +
...
ggsave("figures/NEW_Figure_s5d_general_exclude_covid_15_180_highrisk.png", plot = p_s5c, width = 20, height = 10, units = "cm")
```
