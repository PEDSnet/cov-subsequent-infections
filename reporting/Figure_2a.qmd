...
## New Fig 2a: RSV 3 periods 
```{r New_figure_2a_highrisk_rsv_3periods, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width=8, fig.height=6}
...
# rsv_iptw_15_180_highrisk <- analytic_dataset_final_highrisk %>%
#   do_iptw(cohort_entry_start_date = cohort_entry_start_date,
#           comparison_cohort = comparison_group,
#           weight_formula = "covid~age_group+sex_cat+race_eth_cat+ce_week_factor+highrisk_flag",
#           iptw_description = "covid_Influenza_rsv_15_to_180_highrisk")

df_15_180_highrisk <- results_tbl( paste0("covid_Influenza_rsv_15_to_180_highrisk",'_tabc')) %>%
  collect()
...
#                 labs(x = "Odd ratios", y = "") 
# 
# ggsave("figures/NEW_Figure_2a_rsv_highrisk_3periods.png", plot = p_2a_3periods, width = 20, height = 10, unit = "cm")
```

```{r new_fig2a_3periods_stats, results = "asis", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
export_summs(models_highrisk_2a$unw_unadj_0_to_60,
             models_highrisk_2a$w_adj_0_to_60,
             models_highrisk_2a$unw_unadj_1_to_60,
             models_highrisk_2a$w_adj_1_to_60,
             models_highrisk_2a$unw_unadj_15_to_180,
...
## New Fig 2a: RSV 1 period
```{r New_figure_2a_highrisk_rsv, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width=8, fig.height=6}
...
#                 labs(x = "Odd ratios", y = "") 
# 
# ggsave("figures/NEW_Figure_2a_rsv_15_180_highrisk.png", plot = p_2a, width = 20, height = 10, unit = "cm")
```

```{r new_fig2a_stats, results = "asis", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
