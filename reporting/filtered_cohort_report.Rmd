...
This attrition table considers the study period to be broadly defined from ____ to ____

Actual cohort sizes will differ based on the specific study periods for the sub-analyses.
...
TODO: Think about filtering by the study period.
...
## Table: Outcomes statistics per cohort
