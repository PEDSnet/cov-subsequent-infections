---
title: "Subsequent Infections - RSV Study Sensitivity Analysis"
output:
  html_document:
    df_print: paged
    toc: yes
...
**Using TEST ONLY evidence for COVID, Influenza, and RSV, and using diagnoses for respiratory infections**
...
table1(~ rsv_occurrence_period + days_from_index_to_rsv | sub_cohort, 
       data = post_acute_rsv)
