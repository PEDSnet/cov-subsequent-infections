...
- This version of the report excludes the following sites whose proportion of influenza lab-confirmed cases is < 20% from Nov-1, 2022 to Apr 30, 2023:
  - Monte, Nationwide (borderline)
  - Columbia, Emory, Intermountain, Ochsner, Temple, UTH, OSU, UTSW, Wakeforest
...
attrition_resp <- results_tbl(paste0(cohort_1_label_resp, "_attrition_site_excl")) %>% 
  collect()
...
attrition <- results_tbl(paste0(cohort_1_label, "_attrition_site_excl")) %>% 
  collect()
...
# Figure 1: Epi curve 
![figure_1_epi_curve](../results/figures_10082024/Figure_1_epi_curve_site_excl.png)
...
![figure_2a](../results/figures_10082024/Figure_2a_rsv_15_180_highrisk_1period_site_excl.png)
...
![figure_2a](../results/figures_10082024/Figure_2b_ari_with_covid_30_180_highrisk_site_excl.png)
...
![figure_2a](../results/figures_10082024/Figure_2c_general_30_180_highrisk_site_excl.png)
...
![figure_s3a](../results/figures_10082024/Figure_s3a_rsv_15_180_highrisk_site_excl.png)
...
![figure_s3c](../results/figures_10082024/Figure_s3c_general_30_180_highrisk_site_excl.png)
